package risobiwalrus.world.gen;
...
public class ModEntityGeneration {
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        addEntityToSpecificBiomes(event, ModEntityTypes.WALRUS.get(),
                1, 0, 2, Biomes.DEEP_FROZEN_OCEAN);
        addEntityToSpecificBiomes(event, ModEntityTypes.WALRUS.get(),
                1, 0, 2, Biomes.FROZEN_OCEAN);
        addEntityToSpecificBiomes(event, ModEntityTypes.WALRUS.get(),
                1, 0, 2, Biomes.SNOWY_BEACH);
        addEntityToSpecificBiomes(event, ModEntityTypes.WALRUS.get(),
                1, 0, 2, Biomes.FROZEN_RIVER);
